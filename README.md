...
- `public/assets/` — game-ready SVG sprites for the player, current supplies, hazards, and Cliff sign; supplied inspection images remain in `public/reference/`.
