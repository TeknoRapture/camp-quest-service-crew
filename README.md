...
Game concept:
A retro top-down 2D adventure game set at Brigade Camp at Stony Glen. The player is part of Service Crew. When the morning bell rings, Service Crew starts the day by finding supplies, cleaning shower houses, finding more supplies, restocking supplies, taking out trash, and delivering supplies around camp, while avoiding various hazards. 

Style:
- Retro top-down 2D adventure
- 16-bit-inspired, not strict 8-bit
- Warm outdoorsy camp colors
- Funny, wholesome, service-focused, lightly mysterious
- Client-side only
- No login
- No database
- No backend server
