...
export const npcs: NPCDefinition[] = [
  { id: 'coop', label: 'Coop', displayName: 'Coop', accent: '#a43f28', portraits: { default: 'assets/portraits/coop-npc-portrait.png' }, dialogueId: 'coop', quests: { questGiver: true, offersQuestIds: ['morningSupplyScramble'], involvedQuestIds: ['morningSupplyScramble'] }, x: 1540, y: 1130, w: 28, h: 34 },
  ...
  { id: 'crazyjoe', label: 'Ranger Eoj', displayName: 'Ranger Eoj', accent: '#cf6f38', dialogueId: 'crazyjoe', x: 3060, y: 2200, w: 28, h: 34 },
