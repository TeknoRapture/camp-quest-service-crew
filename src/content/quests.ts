...
export const morningSupplyScrambleQuest: QuestDefinition = {
  ...
  objectives: [
    ...
    { id: 'cleanShowerSpot1', label: 'Clean shower stall 1 with the blue mop', type: 'cleanTarget', targetId: 'showerCleaningSpot1', mapId: 'showerHouse', target: { type: 'interactable', id: 'showerCleaningSpot1', mapId: 'showerHouse', label: 'Shower House' }, prerequisiteObjectiveIds: ['delivered'], rewards: [{ type: 'addScore', amount: 25 }, { type: 'showToast', text: 'Shower stall 1 sparkles. Service Crew dignity +1.' }] },
    { id: 'cleanShowerSpot2', label: 'Clean shower stall 2 with the blue mop', type: 'cleanTarget', targetId: 'showerCleaningSpot2', mapId: 'showerHouse', target: { type: 'interactable', id: 'showerCleaningSpot2', mapId: 'showerHouse', label: 'Shower House' }, prerequisiteObjectiveIds: ['cleanShowerSpot1'], rewards: [{ type: 'addScore', amount: 25 }, { type: 'showToast', text: 'Shower stall 2 is clean. The flip-flops have been avenged.' }] },
    { id: 'cleanShowerSpot3', label: 'Clean the sink corner with the blue mop', type: 'cleanTarget', targetId: 'showerCleaningSpot3', mapId: 'showerHouse', target: { type: 'interactable', id: 'showerCleaningSpot3', mapId: 'showerHouse', label: 'Shower House' }, prerequisiteObjectiveIds: ['cleanShowerSpot2'], rewards: [{ type: 'addScore', amount: 25 }, { type: 'showToast', text: 'Sink corner cleaned. The mystery splashes are now history.' }] },
    { id: 'cleanShowerSpot4', label: 'Clean the changing area with the blue mop', type: 'cleanTarget', targetId: 'showerCleaningSpot4', mapId: 'showerHouse', target: { type: 'interactable', id: 'showerCleaningSpot4', mapId: 'showerHouse', label: 'Shower House' }, prerequisiteObjectiveIds: ['cleanShowerSpot3'], rewards: [{ type: 'addScore', amount: 25 }, { type: 'showToast', text: 'Shower House cleaning loop complete. Coop would nod approvingly.' }] },
    { id: 'bridge', label: 'Investigate the blocked Back 40 bridge', type: 'completeInteraction', interactableId: 'back40TeaserMessage', mapId: 'mainCamp', target: { type: 'interactable', id: 'back40TeaserMessage', mapId: 'mainCamp', label: 'Back 40 bridge' }, prerequisiteObjectiveIds: ['cleanShowerSpot4'], rewards: [{ type: 'addScore', amount: 50 }, { type: 'setFlag', flag: 'bridgeTeaserInspected', value: true }] },
  ],
};
