...
export const mainCamp: MapDefinition = {
  ...
  terrain: [
    ...
    { id: 'westGorge', kind: 'gorge', label: 'Cliff / Gorge Warning Area', x: 0, y: 120, w: 125, h: 1040 },
    { id: 'westStream', kind: 'stream', x: 135, y: 150, w: 55, h: 1020 },
    ...
    { id: 'lake', kind: 'lake', label: 'Milner Lake', x: 1950, y: 80, w: 450, h: 470 },
